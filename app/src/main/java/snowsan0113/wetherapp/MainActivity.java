...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton weather_button = findViewById(R.id.weather_location_button);
        ImageButton button = findViewById(R.id.weather_location_backbutton);
        ButtonListener listener = new ButtonListener(this);
        weather_button.setOnClickListener(listener);
        button.setOnClickListener(listener);
        findViewById(R.id.weather_location_backbutton).setOnClickListener(listener);
